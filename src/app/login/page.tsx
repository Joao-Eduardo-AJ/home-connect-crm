...
const Login = () => (
  <main className="flex h-svh items-center justify-between overflow-hidden text-gray-800">
    ...
    <aside className="relative -z-20 flex h-full w-0 max-w-lg flex-col gap-4 overflow-hidden bg-primary-200 text-primary-900 dark:bg-primary-900 dark:text-primary-100 lg:w-full lg:pl-8 lg:pr-32 lg:pt-32">
